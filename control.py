...
def camera(rocket, ground, gravity, rocket_empty_mass, rocket_fuel_mass, ceiling, screenx, space, gear):
    ...
    # rocket.body.apply_force_at_local_point((-drag[0], 0), (0, rocket.w/2))
    #
    # print(-drag[0]/2)

    return rocket_pos, rocket_mass, angle, air_density, air_speed_angle, gravity

def keys(space, rocket_fuel_mass, engine_massflow, ground, thrust, force_rcs, angle, rocket, joint1, joint2, leg1, leg2, gear):
